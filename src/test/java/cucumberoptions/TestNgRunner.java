...
@CucumberOptions(features = "src/test/resources", glue = "StepDefination", monochrome = true, tags ="@SmokeTest or @Monkey or @LinkedTest or @TreesTest or @QueuesTest or @GraphsTest", plugin = {
